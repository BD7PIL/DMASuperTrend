...
4. If requested with additional context (e.g., "update memory bank using information from 'Makefile")' (see below for file content), focus special attention on that source
